...
export default async function LandingPage({ params }: Props) {
  ...
  const jsonLdApp = {
    ...
    description:
      'AI-powered family calendar assistant that merges Google Calendars into daily briefings on Telegram and WhatsApp with voice summaries, smart pickup order, and Hebrew calendar support.',
    ...
    featureList: [
      ...
      'WhatsApp integration with full feature parity',
    ],
    inLanguage: ['he', 'en', 'ru'],
  };
  ...
  return (
    <>
      ...
      <SiteHeader locale={locale} ctaText={t('header.startFree')} navLinks={navLinks} waUrl={waUrl} />
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="mb-4 text-sm font-medium uppercase tracking-wider text-text-muted">{t('hero.startFree')}</p>
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
            <a
              href={TG_BOT_URL}
              className="inline-flex items-center justify-center gap-3 rounded-xl bg-brand-telegram px-7 py-4 text-lg font-semibold text-white shadow-lg shadow-brand-telegram/25 transition-all hover:scale-105 hover:shadow-xl"
            >
              <TelegramIcon />
              Telegram
            </a>
            <a
              href={waUrl}
              className="inline-flex items-center justify-center gap-3 rounded-xl bg-brand-whatsapp px-7 py-4 text-lg font-semibold text-white shadow-lg shadow-brand-whatsapp/25 transition-all hover:scale-105 hover:shadow-xl"
            >
              <WhatsAppIcon />
              WhatsApp
            </a>
      ...
      <SiteFooter
        ...
        startTelegram={t('footer.startTelegram')}
        startWhatsapp={t('footer.startWhatsapp')}
        waUrl={waUrl}
      />
    </>
  );
