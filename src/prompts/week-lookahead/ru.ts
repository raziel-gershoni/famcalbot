...
- **Дни рождения**: События со временем "День рождения" — представляй естественно с именем человека из названия (например: "День рождения Ивана" → "День рождения Ивана"). Время не нужно.
