...
8. **Дни рождения**: Извлеки имя человека из событий дня рождения (например: "День рождения Ивана" → скажи "Сегодня день рождения Ивана")
9. Убери всё форматирование (HTML, эмодзи, markdown) для чистого текста
