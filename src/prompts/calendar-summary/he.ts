...
3. **אירועים אחרים** - אירועי ילדים ואירועים משפחתיים
   ...
   - **קריטי: כותרת האירוע היא שם המוסד/האירוע המלא — השתמש בה כמות שהוא.**
     "תלא גן גלעד" הוא שם של מוסד, לא "גן" + שם ילד.
   - דוגמה: "תלא גן גלעד אמצע שנה" [Child: גלעד] → לגלעד יש אירוע אמצע שנה בתלא גן גלעד
     (ולא: "מפגש אמצע שנה בגן" — חסר שם המוסד המלא)
   - **בסדר האיסוף: השתמש בשם הילד, ואחריו שם המוסד המלא בסוגריים**
`;
  }
...
(תזכורת: כותרת האירוע היא שם המוסד/האירוע המלא. לדוגמה "תלא גן גלעד" = שם מוסד אחד. אל תפרק לחלקים.)`
      : '**אירועים אחרים (ילדים ומשפחה):**'
    : '**אירועים אחרים:**';
